...
c***********************************************************************
      ...
      real*8 rcond
c
c     sgbco factors a real*8 band matrix by gaussian
...
c***********************************************************************
      ...
      real*8 rcond
c
c     spoco factors a real*8 symmetric positive definite matrix
c     and estimates the condition of the matrix.
c
...
c***********************************************************************
      ...
      real*8 a(lda,1)
c
c     spofa factors a real*8 symmetric positive definite matrix.
c
...
c***********************************************************************
      ...
      real*8 a(lda,1),b(1)
c
c     sposl solves the real*8 symmetric positive definite system
c     a * x = b
...
c     real*8 symmetric positive definite matrix (see below)
...
c***********************************************************************
      ...
      real*8 rcond
c
c     sppco factors a real*8 symmetric positive definite matrix
...
c***********************************************************************
      ...
      real*8 ap(1)
c
c     sppfa factors a real*8 symmetric positive definite matrix
c     stored in packed form.
c
...
c***********************************************************************
      ...
      real*8 ap(1),b(1)
c
c     sppsl solves the real*8 symmetric positive definite system
c     a * x = b
...
c     of a real*8 symmetric positive definite matrix
c     using the factors computed by sppco or sppfa .
c
c     on entry
c
...
c***********************************************************************
      ...
      real*8 rcond
c
c     spbco factors a real*8 symmetric positive definite matrix
...
c***********************************************************************
      ...
      real*8 abd(lda,1)
c
c     spbfa factors a real*8 symmetric positive definite matrix
...
c***********************************************************************
      ...
      real*8 abd(lda,1),b(1)
c
c     spbsl solves the real*8 symmetric positive definite band
c     system  a*x = b
...
c     of a real*8 symmetric positive definite band matrix
c     using the factors computed by spbco or spbfa.
...
c***********************************************************************
      ...
      real*8 rcond
c
c     ssico factors a real*8 symmetric matrix by elimination with
...
c***********************************************************************
      ...
      real*8 a(lda,1)
c
c     ssifa factors a real*8 symmetric matrix by elimination
...
c***********************************************************************
      ...
      real*8 a(lda,1),b(1)
c
c     ssisl solves the real*8 symmetric system
c     a * x = b
...
c     of a real*8 symmetric matrix using the factors from ssifa.
c
c     on entry
c
c        a       real*8(lda,n)
...
c***********************************************************************
      ...
      real*8 rcond
c
c     sspco factors a real*8 symmetric matrix stored in packed
...
c***********************************************************************
      ...
      real*8 ap(1)
c
c     sspfa factors a real*8 symmetric matrix stored in
...
c     of a real*8 symmetric matrix using the factors from sspfa,
...
c***********************************************************************
      ...
      real*8 rcond
c
c     strco estimates the condition of a real*8 triangular matrix.
c
c     on entry
c
c        t       real*8(ldt,n)
...
c
c     strdi computes the determinant and inverse of a real*8
c     triangular matrix.
c
c     on entry
c
...
c                       (    -s(i)      c(i) )
c
c     the rotations are chosen so that c(i) is real*8.
c
c     on entry
c
c         r      real*8(ldr,p), where ldr .ge. p.
...
c
c         z      real*8(ldz,nz), where ldz .ge. p.
...
c-
      integer i,ii,j
      real*8 a,alpha,azeta,norm,snrm2,scale
      real*8 sdot,t,zeta,b,xx
c
...
c                           (    -s(i)      c(i) )
c
c     where c(i) is real*8, the rows these rotations operate on
...
c     on entry
c
c        x       real*8(ldx,p), where ldx .ge. n.
...
c
            ...
            if (nrmxl .eq. 0.0d0) go to 180
               ...
               call sscal(n-l+1,1.0d0/nrmxl,x(l,l),1)
               x(l,l) = 1.0d0 + x(l,l)
c
...
c
c
c     ssvdc is a subroutine to reduce a real*8 nxp matrix x by
...
c     on return
c
c         s         real*8(mm), where mm=min(n+1,p).
...
c
c         u         real*8(ldu,k), where ldu.ge.n.  if joba.eq.1 then
...
c
c         v         real*8(ldv,p), where ldv.ge.p.
...
c
     ...
     *        mm,mm1,mp1,nct,nctp1,ncu,nrt,nrtp1
      real*8 sdot,t
      real*8 b,c,cs,el,emm1,f,g,snrm2,scale,shift,sl,sm,sn,smm1,t1,test,
     *     ztest
      logical wantu,wantv
c
c
...
c
            ...
            if (s(l) .eq. 0.0d0) go to 10
               ...
               call sscal(n-l+1,1.0d0/s(l),x(l,l),1)
               x(l,l) = 1.0d0 + x(l,l)
   10       continue
            s(l) = -s(l)
   20    continue
...
c
            ...
            if (e(l) .eq. 0.0d0) go to 80
               ...
               call sscal(p-l,1.0d0/e(l),e(lp1),1)
               e(lp1) = 1.0d0 + e(lp1)
   80       continue
            e(l) = -e(l)
...
c
  ...
  210          continue
  220          continue
               call sscal(n-l+1,-1.0d0,u(l,l),1)
               u(l,l) = 1.0d0 + u(l,l)
               lm1 = l - 1
...
c
            if (s(l) .ge. 0.0d0) go to 580
               s(l) = -s(l)
               if (wantv) call sscal(p,-1.0d0,v(1,l),1)
  580       continue
c
...
c     fortran abs,aimag,max,cmplx,conjg,real
c-
c
c     internal variables
c
...
c     linpack cgbfa
c     blas caxpy,cdotc,csscal,scasum
c     fortran abs,aimag,max,cmplx,conjg,max,min0,real
c-
c
c     internal variables
c
...
c
c     blas caxpy,cscal,icamax
c     fortran abs,aimag,max,min0,real
c-
c
c     internal variables
c
...
c
c     blas cdotc
c     fortran aimag,cmplx,conjg,max,real,sqrt
c-
c
c     internal variables
c
...
c     fortran abs,aimag,max,cmplx,abs,real
c-
c
c     internal variables
c
...
c     fortran abs,aimag,max,real,sqrt
c-
c
c     internal variables
c
...
c     linpack cspfa
c     blas caxpy,cdotu,csscal,scasum
c     fortran abs,aimag,max,cmplx,iabs,real
c-
c
c     internal variables
c
...
c     linpack chifa
c     blas caxpy,cdotc,csscal,scasum
c     fortran abs,aimag,max,cmplx,conjg,iabs,real
c-
c
c     internal variables
c
...
c
c     blas caxpy,cswap,icamax
c     fortran abs,aimag,max,cmplx,conjg,real,sqrt
c-
c
c     internal variables
c
...
c     fortran abs,aimag,max,cabs,cmplx,csqrt,min0,real
c-
c
c     internal variables
c
...
c     fortran abs,aimag,max,cabs,cmplx
c     fortran conjg,max,min0,mod,real,sqrt
c-
c
c     internal variables
c
